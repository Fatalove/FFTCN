...
if __name__ == "__main__":
    ...
    model = WaveletModel(device, save_path, name=model_name)
    print('=========================================pretrain=========================================')
    # 原代码：
    # batch_size = 128
    # n_epoch = 20
    ...
    train_loader = Sleep_Loader(data_path, 'train', batch_size, balance=not args.no_balance, ratio=ratio, seed=seed, wave="only", waveshape=waveshape, size=args.size)
    valid_loader = Sleep_Loader(data_path, 'valid', batch_size, balance=False, ratio=ratio, seed=seed, wave="only", waveshape=waveshape, size=args.size)
